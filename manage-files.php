...
if (isset($_GET['uid']) && $_GET['action'] == 'del') {
    $fileid = $_GET['uid'];
    $query = mysqli_query($con, "delete from files where id='$fileid'");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="manage-files.php?uid=<?php echo $row['id']; ?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete ?')">
